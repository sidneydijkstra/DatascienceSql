...
sqlRunOrder = [
    ...
    #"sql/raw_db_create.sql",
    #"sql/raw_db_fill.sql",

    # create real database
    "sql/real_db_create.sql",

    # fill real database (here we made sure the creation is happening in the right order)
    "sql/real_db_create_business.sql",
    "sql/real_db_create_movie.sql",
    "sql/real_db_create_serie.sql",
    "sql/real_db_create_genre.sql",
    "sql/real_db_create_country.sql",
    "sql/real_db_create_biography.sql",
    "sql/real_db_create_movie_locations.sql",
    "sql/real_db_create_movie_rating.sql",
    "sql/real_db_create_movie_runtime.sql",
    "sql/real_db_create_serie_locations.sql",
    "sql/real_db_create_serie_rating.sql",
    "sql/real_db_create_serie_runtime.sql",

    "sql/real_db_create_actor.sql",
    "sql/real_db_create_actress.sql",
    "sql/real_db_create_writer.sql"
]
