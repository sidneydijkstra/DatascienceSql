/* actress */
INSERT INTO db_datascience.Actress (movie_Id, biography_Id, serie_Id, actorName, movieOrShowName, date, epNameOrVoice, role)
SELECT m.movie_Id, b.biography_Id, s.serie_Id, ra.actorname, ra.movieOrShowName, ra.date, ra.epnameorvoice, ra.role FROM raw.Actress ra
...
/*SELECT * FROM db_datascience.Actress WHERE db_datascience.Actress.movie_Id IS NOT NULL;*/
